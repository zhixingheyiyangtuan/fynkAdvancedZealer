...
// 图标的比例
#define IWTabBarButtonImageRatio 0.65
 ...
 *  提醒数字
 */
@property (nonatomic, weak) PTBadgeButton *badgeButton;
...
//        self.backgroundColor = [UIColor yellowColor];
        ...
        // 字体大小
        self.titleLabel.font = SYSTEMMIDDLEFONT;
        // 文字颜色
        [self setTitleColor:SYSYTEMAINGRAY forState:UIControlStateNormal];
        
        [self setTitleColor:SYSYTEMAINBLUE forState:UIControlStateSelected];
        
//        [self setBackgroundImage:[UIImage imageNamed:@"tabbar_slider_os7"] forState:UIControlStateSelected];
        
        
        // 添加一个提醒数字按钮
        PTBadgeButton *badgeButton = [[PTBadgeButton alloc] init];
