...
//    [PTCommonTools chooseRootController];
//    [Bugly startWithAppId:@"75992ae964"];
   
   
    
     self.window = [[UIWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
    PTTabBarViewController *tabBarVC = [[PTTabBarViewController alloc]init];
    ...
    /*
    self.window = [[UIWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
    PTNewfeatureViewController *newfeatureVC = [[PTNewfeatureViewController alloc]init];
